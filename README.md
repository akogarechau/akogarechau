...
- **Ненумерованный список файлов и папок:**  
  ...
  -  Все работы находятся в репозитории `Uchupaiton`, отсортированы как надо!
...
| 10:15-11:45| Дискретная математика                | Математика                           | Программирование                     | ОРГ                                    | Иностранный язык                             | Математика                       |
